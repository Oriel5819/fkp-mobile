...
import 'package:fkpmobile/register.dart';
...
class _LoginState extends State<Login> {
  ...
  // final _loginURL = 'https://fake-profile.herokuapp.com/'; // for heroku
  // final _loginURL = 'http://10.0.2.2:3005/'; // for local
  User user = User('', '');
  ApiURL api = ApiURL();
  ...
  Future<http.Response?> login() async {
    http.Response response = await http.post(Uri.parse(api.URI + "users/login"),
